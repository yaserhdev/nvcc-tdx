(function () {
  ...
  var FLAGS = {
    ...
    formReleaseNotes:   true,   // Release notes overlay (form 12519)
  ...
  // ─── CORE — always loaded ─────────────────────────────────────────────────
  // Exposes window.NVCC, nvccShowFormOverlay, and the early postMessage
  // listener that all form modules depend on.
  load(BASE + 'core.js' + v);
  ...
  if (FLAGS.formReleaseNotes) load(BASE + 'form-release-notes.js' + v);
