  ...
  if (window.location.pathname.toLowerCase().indexOf('/sbtdclient/413/portal/requests/servicecatalog/category/3374') !== -1) {
    ...
    customBlock.innerHTML = [
      '<style>',
        ...
        // Quick Decision Guide callout — gold variant matching portal callout pattern
        '#nvcc-old-custom .old-callout {',
          ...
          'font-size: 13.5px;',
        '}',
        '#nvcc-old-custom .old-callout-label {',
          'font-weight: 700;',
          'color: #1a1a1a;',
        '}',
        '#nvcc-old-custom .old-callout ul {',
          'margin: 8px 0 0 0;',
          'padding-left: 20px;',
          'list-style: disc;',
        '}',
        '#nvcc-old-custom .old-callout li {',
          'margin-bottom: 4px;',
          'color: #333;',
        '}',
        '#nvcc-old-custom .old-callout li strong {',
          'color: #1a1a1a;',
        '}',

        // Submit line
        '#nvcc-old-custom .old-submit {',
          'margin-bottom: 20px;',
          'font-size: 14px;',
          'color: #333;',
        '}',

        // Form links — card pattern with green left rail
        '#nvcc-old-custom .old-links {',
          'display: flex;',
          'flex-direction: column;',
          'gap: 8px;',
        '}',
        '#nvcc-old-custom .old-link {',
          'display: block;',
          'padding: 11px 16px;',
          'background: #fff;',
          ...
          'transition: border-left-color 0.2s ease, color 0.2s ease, box-shadow 0.2s ease, transform 0.2s ease;',
        '}',
        '#nvcc-old-custom .old-link:hover,',
        '#nvcc-old-custom .old-link:focus {',
          ...
          'outline: none;',
        '}',
        '#nvcc-old-custom .old-link:focus-visible {',
      ...
      '<div class="old-callout" role="note">',
        '<span class="old-callout-label">&#9889; Quick Decision Guide</span> &#8212; There are <strong>two types of assistance available</strong>:',
        '<ul>',
          '<li><strong>NOVA Credit Courses (Continuous Learning Program)</strong> &#8212; For courses taken at NOVA at no cost</li>',
          '<li><strong>External Course Tuition Assistance</strong> &#8212; For courses taken outside NOVA</li>',
        '</ul>',
      '</div>',
      ...
      '<div class="old-links">',
        '<a class="old-link" href="https://us1.teamdynamix.com/tdapp/app/form/start?c=NDc3ZmE3MWEtMWVkYy00M2RmLTg2NDctNzM0NThlMDJiY2Uw&t=NVJjL05RPT1TSFVSWmZpS3QyZnp6THYwRlF6Y3RacUxiRGtDaERnMXp4YkhVanQxTTdZdUlGUGRlV2hFaEhZNzVyR3lMcS9NR1Rnc3FzYWVlcnJLUDNZL3lWTWR4SUNTaVlKenpWOUVrTmJLSm4xUlJkL1ZmQ0xxTVdybW1TZmlTV0FEMDgzTg&i=d0131f0f-2b5d-41c1-ac01-1c124044e5f5" target="_blank" rel="noopener">',
          'Employee Educational Assistance Request &#8212; External Course',
          '<span class="sr-only"> (opens in a new tab)</span>',
        '</a>',
        '<a class="old-link" href="https://us1.teamdynamix.com/tdapp/app/form/start?c=NDc3ZmE3MWEtMWVkYy00M2RmLTg2NDctNzM0NThlMDJiY2Uw&t=NVJjL05RPT1YN1pGeGZQRDBqVGtaeTk3N2JlYllrYnNRa2RDcnU0UVNCcGdXUjJHb1hWQURwRlNLYTQxeWhhc04wblliTFBnV3B5TnN3UWtvWkNtUi9FSG91N0J5REZkR29kTDlyZnptbkh6cVMzNW10SFhCSjRJOHVUTlk3NTNVYTFZNC9ibw&i=7f8218c0-71da-42bd-a671-d7533c7d0c8a" target="_blank" rel="noopener">',
          'Employee Educational Assistance Request &#8212; NOVA Credit Course',
          '<span class="sr-only"> (opens in a new tab)</span>',
        '</a>',
      '</div>',
    ].join('');
    ...
    sidebarButtons.innerHTML = [
      '<span>',
        '<a class="DetailAction" href="https://us1.teamdynamix.com/tdapp/app/form/start?c=NDc3ZmE3MWEtMWVkYy00M2RmLTg2NDctNzM0NThlMDJiY2Uw&t=NVJjL05RPT1YN1pGeGZQRDBqVGtaeTk3N2JlYllrYnNRa2RDcnU0UVNCcGdXUjJHb1hWQURwRlNLYTQxeWhhc04wblliTFBnV3B5TnN3UWtvWkNtUi9FSG91N0J5REZkR29kTDlyZnptbkh6cVMzNW10SFhCSjRJOHVUTlk3NTNVYTFZNC9ibw&i=7f8218c0-71da-42bd-a671-d7533c7d0c8a" target="_blank" rel="noopener">',
