(function () {
  ...
  style.textContent = [
    ...
    // Remove margin from the hidden config static content widget (always first static_content field)
    "form.js-entry-form .form-group[data-fieldtype=\"static_content\"]:first-of-type { margin: 0; }",
  ].join(" ");
